...
{
public:
  THRUST_HOST_DEVICE custom_numeric()
  {
    fill(0);
  }
  ...
  THRUST_HOST_DEVICE custom_numeric(const T& i)
  {
    fill(static_cast<int>(i));
  }

  THRUST_HOST_DEVICE custom_numeric(const custom_numeric& other)
  {
    fill(other.value[0]);
  }

  THRUST_HOST_DEVICE custom_numeric& operator=(int val)
  {
    fill(val);
    return *this;
  }

  THRUST_HOST_DEVICE custom_numeric& operator=(const custom_numeric& other)
  {
    fill(other.value[0]);
    return *this;
  }
  ...
  THRUST_HOST_DEVICE operator void*() const
  {
...
#define DEFINE_OPERATOR(op)                                \
  THRUST_HOST_DEVICE custom_numeric& operator op()         \
  {                                                        \
    fill(op value[0]);                                     \
    return *this;                                          \
  }                                                        \
  THRUST_HOST_DEVICE custom_numeric operator op(int) const \
  {                                                        \
...
#define DEFINE_OPERATOR(op)                             \
  THRUST_HOST_DEVICE custom_numeric operator op() const \
  {                                                     \
...
#define DEFINE_OPERATOR(op)                                                        \
  THRUST_HOST_DEVICE custom_numeric operator op(const custom_numeric& other) const \
  {                                                                                \
...
#define DEFINE_OPERATOR(op)                                                               \
  THRUST_HOST_DEVICE custom_numeric& operator CONCAT(op, =)(const custom_numeric & other) \
  {                                                                                       \
...
#define DEFINE_OPERATOR(op)                                                                        \
  THRUST_HOST_DEVICE friend bool operator op(const custom_numeric& lhs, const custom_numeric& rhs) \
  {                                                                                                \
...
private:
  ...
  THRUST_HOST_DEVICE void fill(int val)
  {
    for (int i = 0; i < 5; ++i)
    {
      value[i] = val;
