...
def plot_data(
    ...
    for prec, _ in gflops_dict0.items():
        ...
        for gflops_dict1, gflops_dict2, funcname, const_args_dict in zip(
            gflops_dicts1, gflops_dicts2, funcname_list, const_args_dicts
        ):
            ...
            axes.scatter(
                sorted_sizes1, sorted_gflops1, color=cur_color, label=function_label
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-l", "--level", help="BLAS level", dest="level", default="blas1"
    )
    ...
    if args.theo_max == True:
        ...
        savedir = os.path.join(
            args.level, args.tag1 + "_" + args.tag2, "plots_perf_vs_perf"
        )
