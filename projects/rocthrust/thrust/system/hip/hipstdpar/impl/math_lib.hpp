...
inline __device__ __attribute__((used)) float __hipstdpar_atan2_f32(float x, float y)
{
  return __ocml_atan2_f32(x, y);
}

inline __device__ __attribute__((used)) double __hipstdpar_atan2_f64(double x, double y)
{
...
inline __device__ __attribute__((used)) float __hipstdpar_fdim_f32(float x, float y)
{
  return __ocml_fdim_f32(x, y);
}

inline __device__ __attribute__((used)) double __hipstdpar_fdim_f64(double x, double y)
{
  return __ocml_fdim_f64(x, y);
}

inline __device__ __attribute__((used)) float __hipstdpar_hypot_f32(float x, float y)
{
  return __ocml_hypot_f32(x, y);
}

inline __device__ __attribute__((used)) double __hipstdpar_hypot_f64(double x, double y)
{
...
inline __device__ __attribute__((used)) float __hipstdpar_nextafter_f32(float x, float y)
{
  return __ocml_nextafter_f32(x, y);
}

inline __device__ __attribute__((used)) double __hipstdpar_nextafter_f64(double x, double y)
{
  return __ocml_nextafter_f64(x, y);
}

// No long double support on AMDGPU so for nexttoward we forward to nextafter
inline __device__ __attribute__((used)) float __hipstdpar_nexttoward_f32(float x, float y)
{
  return __ocml_nextafter_f32(x, y);
}

inline __device__ __attribute__((used)) double __hipstdpar_nexttoward_f64(double x, double y)
{
  return __ocml_nextafter_f64(x, y);
}

inline __device__ __attribute__((used)) double __hipstdpar_pow_f64(double x, double y)
{
  return __ocml_pow_f64(x, y);
}

inline __device__ __attribute__((used)) float __hipstdpar_remainder_f32(float x, float y)
{
  return __ocml_remainder_f32(x, y);
}

inline __device__ __attribute__((used)) double __hipstdpar_remainder_f64(double x, double y)
{
  return __ocml_remainder_f64(x, y);
}

inline __device__ __attribute__((used)) float __hipstdpar_remquo_f32(float x, float y, int* p)
{
  int t{};
...
inline __device__ __attribute__((used)) double __hipstdpar_remquo_f64(double x, double y, int* p)
{
  int t{};
...
inline __device__ __attribute__((used)) float __hipstdpar_scalbln_f32(float x, long e)
{
  return __ocml_scalb_f32(x, e);
}

inline __device__ __attribute__((used)) double __hipstdpar_scalbln_f64(double x, long e)
{
  return __ocml_scalb_f64(x, e);
}

inline __device__ __attribute__((used)) float __hipstdpar_scalbn_f32(float x, int e)
{
  return __ocml_scalbn_f32(x, e);
}

inline __device__ __attribute__((used)) double __hipstdpar_scalbn_f64(double x, int e)
{
