...
def plot_data(
    ...
    for prec, _ in gflops_dict0.items():
        ...
        for gflops_dict, funcname, const_args_dict in zip(
            gflops_dicts, funcname_list, const_args_dicts
        ):
            ...
            axes.scatter(
                sorted_sizes, sorted_gflops, color=cur_color, label=function_label
            )
...
def get_data_from_file(
    filename,
    output_param="rocblas-Gflops",
    xaxis_str1="N",
    xaxis_str2="M",
    yaxis_str="rocblas-Gflops",
):
